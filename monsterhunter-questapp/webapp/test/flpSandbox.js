			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Quests-display": {
								"semanticObject": "Quests",
								"action": "display",
								"description": "Quest App for IBsolution Monster Hunter",
								"title": "Quests",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ibsolution.monster.monsterhunter-questapp",
									"url": sap.ui.require.toUrl("ibsolution/monster/monsterhunter-questapp")
								}
							}
						}
					}
